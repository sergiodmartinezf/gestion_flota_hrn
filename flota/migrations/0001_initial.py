# Generated by Django 5.2.2 on 2025-12-15 16:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('turno', models.CharField(choices=[('Mañana', 'Mañana'), ('Tarde', 'Tarde'), ('Noche', 'Noche'), ('Larga', 'Jornada Larga')], max_length=20)),
                ...
                ('nivel_combustible_inicio', models.CharField(blank=True, help_text='Ej: 1/2, 3/4, Lleno', max_length=20)),
                ('nivel_combustible_fin', models.CharField(blank=True, help_text='Ej: 1/2, 3/4, Lleno', max_length=20)),
