# Generated by Django 5.2.2 on 2026-05-18 01:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo_presupuesto', models.CharField(choices=[('Preventivo', 'Preventivo (Por Vehículo)'), ('Operativo', 'Correctivo (Bolsa General)')], default='Preventivo', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categoria_traslado', models.CharField(choices=[('PRIMARIO', 'Traslado Primario (Lugar del evento -> Urgencia)'), ('SECUNDARIO', 'Traslado Secundario (Urgencia -> Hospital Base/Red)'), ('OTROS', 'Otros Traslados (Rescates, Exámenes, Especialista)'), ('ALTA', 'Altas'), ('Administrativo', 'Administrativo')], default='Administrativo', max_length=20)),
                ...
                ('sentido', models.CharField(choices=[('IDA', 'Ida'), ('REGRESO', 'Regreso')], default='IDA', max_length=10)),
                ('destino_tipo', models.CharField(choices=[('HBO', 'Hospital Base Osorno'), ('HEPP_PURRANQUE', 'Hospital Dr. Juan Hepp Purranque'), ('H_PUERTO_OCTAY', 'Hospital Puerto Octay'), ('H_RIO_NEGRO', 'Hospital Río Negro'), ('H_FUTA', 'Hospital Futa Srüka Lawenche Kunko Mapu Mo'), ('H_PU_MULEN', 'Hospital Pu Mülen'), ('DOMICILIO', 'Domicilio (Ingresar Dirección)'), ('CESFAM', 'CESFAM'), ('ACHS', 'ACHS/Mutual'), ('OTRO', 'Otro (Especificar)')], max_length=20)),
