# Generated by Django 5.2.2 on 2026-02-02 16:38
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('tipo_mantencion', models.CharField(choices=[('Preventivo', 'Preventivo'), ('Correctivo', 'Correctivo'), ('Productivo', 'Productivo')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo_reporte', models.CharField(choices=[('Falla', 'Falla / Incidente'), ('Desempeño', 'Desempeño del vehículo')], default='Falla', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('origen_llamado', models.CharField(blank=True, max_length=200, verbose_name='Origen del llamado/traslado')),
                ('direccion_domicilio', models.CharField(blank=True, max_length=300, verbose_name='Dirección (cuando destino es domicilio)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('orden', models.PositiveSmallIntegerField(default=1, help_text='Orden del paciente en el viaje')),
                ('paciente', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='viajes', to='flota.paciente')),
                ('viaje', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='pacientes_adicionales', to='flota.viaje')),
            ],
            options={
