# Generated by Django 5.2.2 on 2026-04-27 20:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categoria_traslado', models.CharField(choices=[('PRIMARIO', 'Traslado Primario (Lugar del evento -> Urgencia)'), ('SECUNDARIO', 'Traslado Secundario (Urgencia -> Hospital Base/Red)'), ('OTROS', 'Otros Traslados (Rescates, Exámenes, Especialista)'), ('ALTA', 'Altas'), ('Administrativo', 'Administrativo')], max_length=20)),
